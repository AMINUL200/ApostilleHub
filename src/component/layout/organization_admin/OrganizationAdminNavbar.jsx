...
const OrganizationAdminNavbar = ({ setSidebarOpen, sidebarOpen }) => {
  ...
  const notifications = [
    {
      ...
      message: "Alex Turner accepted your invite",
      time: "10 min ago",
      unread: true,
      icon: User,
      color: "#0F9B8E",
    },
    {
      ...
      message: "Your invoice for August is ready",
      time: "1 hour ago",
      unread: true,
      icon: Zap,
      color: "#D4AF37",
    },
    {
      ...
      message: "Order #APS-40220 from your team",
      time: "2 hours ago",
      unread: false,
  ...
  const handleProfileClick = () => {
    setShowProfileMenu(false);
    navigate("/organization-admin/profile");
  };

  const handleSettingsClick = () => {
    setShowProfileMenu(false);
    navigate("/organization-admin/settings");
  };
      ...
      <div className="px-6 py-3.5">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="relative" ref={notificationRef}>
              ...
              {showNotifications && (
                <div className="absolute right-0 mt-2 w-80 sm:w-96 bg-white rounded-2xl shadow-2xl border border-gray-200 overflow-hidden z-50 animate-slideDown">
                  <div className="bg-gradient-to-r from-[#0F9B8E] to-[#14C4B4] px-4 py-3.5">
                    <div className="flex items-center justify-between">
                      <div>
                  ...
                  <div className="px-4 py-2.5 bg-gray-50 text-center border-t border-gray-100">
                    <button className="text-sm text-[#0F9B8E] hover:text-[#0B7A70] font-semibold transition-colors">
            ...
            <div className="hidden sm:flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-gradient-to-r from-[#0F9B8E] to-[#14C4B4]">
            ...
            <div className="relative" ref={profileRef}>
              ...
              >
                <div className="w-9 h-9 bg-gradient-to-br from-[#0F9B8E] to-[#14C4B4] rounded-full flex items-center justify-center shadow-md">
                  {userData.avatar ? (
                    <img
                      src={userData.avatar}
                      alt="Profile"
              ...
              {showProfileMenu && (
                <div className="absolute right-0 mt-2 w-64 bg-white rounded-2xl shadow-2xl border border-gray-200 overflow-hidden z-50 animate-slideDown">
                  {/* User Info */}
                  <div className="px-4 py-4 bg-gradient-to-r from-[#0F9B8E] to-[#14C4B4]">
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex items-center gap-1 mt-0.5">
                          ...
                          <p className="text-white/70 text-xs">{userData.organization}</p>
                        </div>
                      </div>
                    </div>
                  </div>
...
export default OrganizationAdminNavbar;